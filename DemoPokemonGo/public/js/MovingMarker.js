...
// var icon = SetIcon('images/character.png');
var character = GetImageCharacter();
var userid = GetUserID();

var user = L.icon({
    // iconUrl: '/images/characters-plays/Takeshi.png',
    iconUrl: '/images/characters/' + character + '.png',
    iconSize: [100, 100],
    name: character,
    id: userid
});
